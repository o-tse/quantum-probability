...
\section{Open Quantum Systems}\label{sec:open-quantum}
...
\]
In particular, $U_t$ commutes with $H$ for all $t\ge 0$.\hfill $\diamondsuit$
\end{remark}
...
\]
Notice that $H_\sfh\in\scrP(\calH)$ happens to be a rank-1 projection on the vector $\e_-$.
